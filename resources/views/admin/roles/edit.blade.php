            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <div class="row m-t-4">
                            <div class="col-md-12 ">
                                <form class="form-horizontal" action="{{ url('admin/roles/'.$role->id) }}" method="POST" role="form">
                                    @csrf
                                    {{ method_field('PUT') }}
                                    <div class="form-group">
                                        <div class="row"  style="margin-top: 10px">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="name" placeholder="Ex. Admin" value="{{  $role->name }}">
                                        ...
                                        <div class="row"  style="margin-top: 10px">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="display_name" placeholder="Ex. Admin" value="{{  $role->display_name }}">
                                                @error('display_name')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
